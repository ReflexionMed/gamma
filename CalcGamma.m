...
elseif size(varargin{1}.width,2) == 2
    ...
    [refX, refY] = meshgrid(single(varargin{1}.start(2):varargin{1}.width(2): ...
        varargin{1}.start(2) + varargin{1}.width(2) * (size(varargin{1}.data,2) - 1)), ...
        single(varargin{1}.start(1): varargin{1}.width(1):varargin{1}.start(1)...
...
elseif size(varargin{2}.width,2) == 2
    ...
    [tarX, tarY] = meshgrid(single(varargin{2}.start(2):varargin{2}.width(2): ...
        varargin{2}.start(2) + varargin{2}.width(2) * ...
